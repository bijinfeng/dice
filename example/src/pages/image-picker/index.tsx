...
import { ImagePicker, Toast, Form, Button, Cell, Dialog } from 'rn-vant';
import { Fire } from '@rn-vant/icons';
...
const ImagePickerExample = () => {
  ...
  return (
    <View style={{ backgroundColor: themeVars.background_2 }}>
      ...
      <DemoBlock title="表单中使用" inset>
        <Form>
          <Cell.Group>
            ...
            <Form.Item rules={{ required: '请上传头像' }} label="上传附件" name="files">
              <ImagePicker />
            </Form.Item>
          </Cell.Group>
        </Form>
