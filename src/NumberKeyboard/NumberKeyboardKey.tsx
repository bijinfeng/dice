...
const NumberKeyboardKey: React.FC<NumberKeyboardKeyProps> = (props) => {
  ...
  const renderContent = () => {
    ...
    const textNode = !isNil(actualText) ? (
      <Text style={textStyle}>{actualText}</Text>
    ) : null;
  ...
  return (
    <View
      style={[styles.wrapper, wider && styles.wider, large && styles.large]}
    >
      <TouchableOpacity
        style={[styles.container, isBlue && styles.blue]}
        activeBackgroundColor={
          color ? undefined : theme.number_keyboard_key_active_color
        }
