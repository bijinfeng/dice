...
import { useRefs, useSetState, useUpdateEffect } from "../hooks";
...
import type { CalendarDayItem, CalendarInstance, CalendarProps } from "./type";
import {
  calcDateNum,
  cloneDate,
  cloneDates,
  ...
  const renderCalendar = () => (
    <View style={[styles.calendar, props.style]}>
      ...
      <View
        style={[
          styles.footer,
          !!props.safeAreaInsetBottom && { paddingBottom: insets.bottom },
        ]}
      >
        {renderFooterButton()}
      </View>
