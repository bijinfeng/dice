...
export const createHeaderStyle = (
  theme: DiceUI.Theme
): StyleSheet.NamedStyles<HeadStyle> => {
...
export const createMonthStyle = (
  theme: DiceUI.Theme
): StyleSheet.NamedStyles<MonthStyle> => {
...
export const createDayStyle = (
  theme: DiceUI.Theme
): StyleSheet.NamedStyles<DayStyle> => {
